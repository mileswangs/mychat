...
from mychat.tokenizer import get_token_bytes
...
run = "dummy"  # wandb run name default("dummy" is a special name, we won't log in wandb)
device_type = ""
    ...
    while True:
        ...
        if split == "train":
            if num_iterations > 0:
                ...
                approx_progress = cursor / datasize
